...
namespace ELibrary_Management
{
    public partial class Penalty : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            + "ON u.UserID = bi.UserID WHERE bi.UserID = " + txtUserID.Text + " AND bi.BookID = " + txtBookID.Text + " AND '" + DateTime.Now + "' - bi.DueDate > 0", conn);
            ...
            {
                Page.ClientScript.RegisterStartupScript(this.GetType(), "Scripts", "<script>swal('Invalid!', '', 'success')</script>");
            }
            conn.Close();
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            + "UPDATE dbo.BookIssue SET Status = -1 WHERE BookIssueID = " + Session["biID"].ToString(), conn);
            DAO.UpdateTable(cmd);
