...
namespace ELibrary_Management
{
    public partial class bookIssueManagement : System.Web.UI.Page
    {
        ...
        protected void databind()
        {
            ...
            GridView1.DataSource = DAO.GetDataTable("SELECT bi.*, bm.*, u.* FROM dbo.BookIssue bi JOIN dbo.[User] u ON u.UserID = bi.UserID JOIN dbo.BookMaster bm ON bm.BookID = bi.BookID");
            GridView1.DataBind();
